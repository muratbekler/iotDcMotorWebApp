...
namespace WebAppService
{
                ...
                case "Initialize":
                    {
                        ...
                        HttpServer server = new HttpServer(80, appServiceConnection);
    ...
    {
        string offHtmlString = "<html><head><title>DC Motor Demo</title></head><body><form action=\"#\" method=\"GET\"><h1>DC Motor Demo</h1><p>Active DC Motor</p><input type=\"radio\" name=\"state\" value=\"on\" onclick=\"this.form.submit()\"> On<br><input type=\"radio\" name=\"state\" value=\"off\" checked onclick=\"this.form.submit()\"> Off</form></body></html>";
        string onHtmlString = "<html><head><title>DC Motor Demo</title></head><body><form action=\"#\" method=\"GET\"><h1>DC Motor Demo</h1><p>Active DC Motor</p><input type=\"radio\" name=\"state\" value=\"on\" checked onclick=\"this.form.submit()\"> On<br><input type=\"radio\" name=\"state\" value=\"off\" onclick=\"this.form.submit()\"> Off</form></body></html>";
...
#pragma warning restore CS4014
        ...
        private async Task WriteResponseAsync(string request, IOutputStream os)
        {
            ...
            //{
                ...
                updateMessage.Add("Adress", state);
